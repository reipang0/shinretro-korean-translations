...
FocusScope {
    ...
    property var dataText: {
        ...
        "ko": {
            ...
            settings_general_colorScheme_OzoneDark: "OzoneDark",
            settings_general_colorScheme_SteamOS: "SteamOS",
            settings_general_logoVariant_mono: "화이트 로고",
            settings_general_logoVariant_color: "컬러 로고",
            global_yes: "예",
            global_no: "아니요",
            global_back: "<b>뒤로</b> 이동",
            global_select: "확인",
            global_games: "게임",
            global_noFavorites: "즐겨찾기 설정 안 됨",
            global_noFilteredGames: "검색 결과가 없습니다",
            global_switch: "변경",
            global_collCategory: "컬렉션 카테고리",
            global_collections: "컬렉션",
            collection_all: "전체",
            collection_favorites: "즐겨찾기에 등록한",
            collection_lastplayed: "가장 최근에 플레이한",
            collectionDetails_gamesAvailable: "게임 플레이 가능",
            games_na: "",
            games_developedBy: "제작사:",
            games_for: "플랫폼:",
            games_players: "플레이어 수",
            games_player: "1 플레이어",
            games_favorited: "즐겨찾기",
            games_arcadeport: "아케이드 포트",
            games_completed: "컴플리트",
            games_withoutDescription: "설명 없음",
            games_removeFavorite: "<b>즐겨찾기</b> 제거",
            games_addFavorite: "<b>즐겨찾기</b> 추가",
            games_filtered: "<b>필터</b>",
            games_filterMultiplayer: "멀티플레이어",
            games_filter: "필터",
            games_sortedBy: "정렬 기준",
            home_continue: "최근 실행한 게임",
            home_favorites: "즐겨찾기",
            home_play: "실행하기 - ",
            settings_general: "일반",
            settings_general_restart: "(재시작 필요)",
            settings_general_language: "언어",
            settings_general_colorScheme: "테마",
            settings_general_selectionFrame: "프레임 색상 선택",
            settings_general_music: "음악",
            settings_general_muteSounds: "사운드 음소거",
            settings_general_logoVariant: "로고 표시(색상)",
            settings_general_region: "로고 표시(지역 설정)",
            settings_general_hideOSC: "컨트롤 힌트 숨기기",
            settings_general_dynamicFontScaling: "동적 폰트 크기 조정",
            settings_general_OSCScheme: "버튼 디자인",
            settings_global_backgroundImg: "배경 이미지",
            settings_global_videoPlayback: "비디오 재생",
            settings_global_videoMute: "비디오 음소거",
            settings_global_ImgPrecompose: "사전 구성된 이미지 사용",
            settings_global_ImgPrecomposePref: "사전 구성된 이미지 유형",
            settings_collection_showAll: '"전체 게임" 컬렉션 표시',
            settings_collection_showFavorites: '"즐겨찾기" 컬렉션 표시',
            settings_collection_showLastPlayed: '"마지막으로 플레이한" 컬렉션 표시',
            settings_collection_accentColor: "강조 색상 밝기",
            settings_collection_accentColorNr: "강조 색상",
            settings_collection_menuColor: "제조업체 로고 표시(색상)",
            settings_games_layout: "게임 레이아웃",
            settings_games_gridItemsPerRow: "게임 그리드 - 행당 항목",
            settings_games_gridItemsViewableRows: "게임 그리드 - 표시되는 행",
            settings_games_BoxArtPref: "선호하는 박스아트 이미지",
            settings_games_page_updown_function: "게임 그리드 - LT/RT 버튼 기능",
            settings_home_videoLogo: "비디오 재생 시 로고 표시",
            menu_settings: "제어판",
            menu_home: "홈",
            menu_collections: "그룹 보기",
            menu_games:"게임"
        },
       "ch": {
